 ...
 * <ul>
 *   <li>{@link BMM.impl.MotivationElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link BMM.impl.MotivationElementImpl#getDescription <em>Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MotivationElementImpl extends MinimalEObjectImpl.Container implements MotivationElement {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BMMPackage.MOTIVATION_ELEMENT__NAME, oldName, name));
	}
