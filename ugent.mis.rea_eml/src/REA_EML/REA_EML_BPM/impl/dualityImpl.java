 ...
 * <ul>
 *   <li>{@link REA_EML.REA_EML_BPM.impl.dualityImpl#getDecrementEconomicEvent <em>Decrement Economic Event</em>}</li>
 *   <li>{@link REA_EML.REA_EML_BPM.impl.dualityImpl#getIncrementEconomicEvent <em>Increment Economic Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class dualityImpl extends ModelElementImpl implements duality {
	...
	protected EClass eStaticClass() {
		return REA_EML_BPMPackage.Literals.DUALITY;
	}
		...
		if (decrementEconomicEvent != null && decrementEconomicEvent.eIsProxy()) {
			...
			if (decrementEconomicEvent != oldDecrementEconomicEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, REA_EML_BPMPackage.DUALITY__DECREMENT_ECONOMIC_EVENT, oldDecrementEconomicEvent, decrementEconomicEvent));
			}
		}
	...
	public void setDecrementEconomicEvent(DecrementEconomicEvent newDecrementEconomicEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, REA_EML_BPMPackage.DUALITY__DECREMENT_ECONOMIC_EVENT, oldDecrementEconomicEvent, decrementEconomicEvent));
	}
	...
	public IncrementEconomicEvent getIncrementEconomicEvent() {
		if (incrementEconomicEvent != null && incrementEconomicEvent.eIsProxy()) {
			...
			if (incrementEconomicEvent != oldIncrementEconomicEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, REA_EML_BPMPackage.DUALITY__INCREMENT_ECONOMIC_EVENT, oldIncrementEconomicEvent, incrementEconomicEvent));
			}
		}
	...
	public void setIncrementEconomicEvent(IncrementEconomicEvent newIncrementEconomicEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, REA_EML_BPMPackage.DUALITY__INCREMENT_ECONOMIC_EVENT, oldIncrementEconomicEvent, incrementEconomicEvent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case REA_EML_BPMPackage.DUALITY__DECREMENT_ECONOMIC_EVENT:
				if (resolve) return getDecrementEconomicEvent();
				return basicGetDecrementEconomicEvent();
			case REA_EML_BPMPackage.DUALITY__INCREMENT_ECONOMIC_EVENT:
