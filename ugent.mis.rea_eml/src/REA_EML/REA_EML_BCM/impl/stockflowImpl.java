 ...
 * <ul>
 *   <li>{@link REA_EML.REA_EML_BCM.impl.stockflowImpl#getEconomicEvent <em>Economic Event</em>}</li>
 *   <li>{@link REA_EML.REA_EML_BCM.impl.stockflowImpl#getEconomicResouce <em>Economic Resouce</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class stockflowImpl extends ModelElementImpl implements stockflow {
	...
	protected EClass eStaticClass() {
		return REA_EML_BCMPackage.Literals.STOCKFLOW;
	}
		...
		if (economicEvent != null && economicEvent.eIsProxy()) {
			...
			if (economicEvent != oldEconomicEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, REA_EML_BCMPackage.STOCKFLOW__ECONOMIC_EVENT, oldEconomicEvent, economicEvent));
			}
		}
	...
	public void setEconomicEvent(EconomicEvent newEconomicEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, REA_EML_BCMPackage.STOCKFLOW__ECONOMIC_EVENT, oldEconomicEvent, economicEvent));
	}
	...
	public EconomicResource getEconomicResouce() {
		if (economicResouce != null && economicResouce.eIsProxy()) {
			...
			if (economicResouce != oldEconomicResouce) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, REA_EML_BCMPackage.STOCKFLOW__ECONOMIC_RESOUCE, oldEconomicResouce, economicResouce));
			}
		}
	...
	public void setEconomicResouce(EconomicResource newEconomicResouce) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, REA_EML_BCMPackage.STOCKFLOW__ECONOMIC_RESOUCE, oldEconomicResouce, economicResouce));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case REA_EML_BCMPackage.STOCKFLOW__ECONOMIC_EVENT:
				if (resolve) return getEconomicEvent();
				return basicGetEconomicEvent();
			case REA_EML_BCMPackage.STOCKFLOW__ECONOMIC_RESOUCE:
