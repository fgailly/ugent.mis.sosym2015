 ...
 * <ul>
 *   <li>{@link REA_EML.REA_EML_BCM.impl.fulfillmentImpl#getEconomicEvent <em>Economic Event</em>}</li>
 *   <li>{@link REA_EML.REA_EML_BCM.impl.fulfillmentImpl#getCommitment <em>Commitment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class fulfillmentImpl extends ModelElementImpl implements fulfillment {
	...
	protected EClass eStaticClass() {
		return REA_EML_BCMPackage.Literals.FULFILLMENT;
	}
		...
		if (economicEvent != null && economicEvent.eIsProxy()) {
			...
			if (economicEvent != oldEconomicEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, REA_EML_BCMPackage.FULFILLMENT__ECONOMIC_EVENT, oldEconomicEvent, economicEvent));
			}
		}
	...
	public void setEconomicEvent(EconomicEvent newEconomicEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, REA_EML_BCMPackage.FULFILLMENT__ECONOMIC_EVENT, oldEconomicEvent, economicEvent));
	}
	...
	public Commitment getCommitment() {
		if (commitment != null && commitment.eIsProxy()) {
			...
			if (commitment != oldCommitment) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, REA_EML_BCMPackage.FULFILLMENT__COMMITMENT, oldCommitment, commitment));
			}
		}
		return commitment;
	}
	...
	public void setCommitment(Commitment newCommitment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, REA_EML_BCMPackage.FULFILLMENT__COMMITMENT, oldCommitment, commitment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case REA_EML_BCMPackage.FULFILLMENT__ECONOMIC_EVENT:
				if (resolve) return getEconomicEvent();
				return basicGetEconomicEvent();
			case REA_EML_BCMPackage.FULFILLMENT__COMMITMENT:
