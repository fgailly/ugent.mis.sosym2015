 ...
 * @generated
 */
public class REA_EML_BCSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case REA_EML_BCPackage.REA_EML_BC_M: {
				REA_EML_BCM reA_EML_BCM = (REA_EML_BCM)theEObject;
				T result = caseREA_EML_BCM(reA_EML_BCM);
				if (result == null) result = caseModel(reA_EML_BCM);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case REA_EML_BCPackage.ECONOMIC_RESOURCE: {
			...
			case REA_EML_BCPackage.ECONOMIC_EVENT: {
			...
			case REA_EML_BCPackage.ECONOMIC_AGENT: {
			...
			case REA_EML_BCPackage.COMMITMENT: {
			...
			case REA_EML_BCPackage.SPECIFICATION: {
			...
			case REA_EML_BCPackage.STOCKFLOW: {
			...
			case REA_EML_BCPackage.FULFILLMENT: {
			...
			case REA_EML_BCPackage.PARTICIPATION: {
			...
			case REA_EML_BCPackage.DUALITY: {
			...
			case REA_EML_BCPackage.RECICPROCITY: {
			...
			case REA_EML_BCPackage.PROVIDES: {
			...
			case REA_EML_BCPackage.RECEIVES: {
	 ...
	 * @generated
	 */
	public T caseREA_EML_BCM(REA_EML_BCM object) {
		return null;
	}
