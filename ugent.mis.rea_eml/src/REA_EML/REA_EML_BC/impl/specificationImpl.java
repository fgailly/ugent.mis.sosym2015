 ...
 * <ul>
 *   <li>{@link REA_EML.REA_EML_BC.impl.specificationImpl#getCommitment <em>Commitment</em>}</li>
 *   <li>{@link REA_EML.REA_EML_BC.impl.specificationImpl#getEconomicResouce <em>Economic Resouce</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class specificationImpl extends ModelElementImpl implements specification {
	...
	protected EClass eStaticClass() {
		return REA_EML_BCPackage.Literals.SPECIFICATION;
	}
		...
		if (commitment != null && commitment.eIsProxy()) {
			...
			if (commitment != oldCommitment) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, REA_EML_BCPackage.SPECIFICATION__COMMITMENT, oldCommitment, commitment));
			}
		}
		return commitment;
	}
	...
	public void setCommitment(Commitment newCommitment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, REA_EML_BCPackage.SPECIFICATION__COMMITMENT, oldCommitment, commitment));
	}
	...
	public EconomicResource getEconomicResouce() {
		if (economicResouce != null && economicResouce.eIsProxy()) {
			...
			if (economicResouce != oldEconomicResouce) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, REA_EML_BCPackage.SPECIFICATION__ECONOMIC_RESOUCE, oldEconomicResouce, economicResouce));
			}
		}
	...
	public void setEconomicResouce(EconomicResource newEconomicResouce) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, REA_EML_BCPackage.SPECIFICATION__ECONOMIC_RESOUCE, oldEconomicResouce, economicResouce));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case REA_EML_BCPackage.SPECIFICATION__COMMITMENT:
				if (resolve) return getCommitment();
				return basicGetCommitment();
			case REA_EML_BCPackage.SPECIFICATION__ECONOMIC_RESOUCE:
