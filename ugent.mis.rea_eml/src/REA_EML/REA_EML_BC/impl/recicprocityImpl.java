 ...
 * <ul>
 *   <li>{@link REA_EML.REA_EML_BC.impl.recicprocityImpl#getCommitment <em>Commitment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class recicprocityImpl extends ModelElementImpl implements recicprocity {
	...
	protected EClass eStaticClass() {
		return REA_EML_BCPackage.Literals.RECICPROCITY;
	}
	...
	public EList<Commitment> getCommitment() {
		if (commitment == null) {
			commitment = new EObjectResolvingEList<Commitment>(Commitment.class, this, REA_EML_BCPackage.RECICPROCITY__COMMITMENT);
		}
		return commitment;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case REA_EML_BCPackage.RECICPROCITY__COMMITMENT:
