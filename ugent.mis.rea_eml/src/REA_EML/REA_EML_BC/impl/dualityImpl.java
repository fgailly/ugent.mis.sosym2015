 ...
 * <ul>
 *   <li>{@link REA_EML.REA_EML_BC.impl.dualityImpl#getEconomicEvent <em>Economic Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class dualityImpl extends ModelElementImpl implements duality {
	...
	protected EClass eStaticClass() {
		return REA_EML_BCPackage.Literals.DUALITY;
	}
	...
	public EList<EconomicEvent> getEconomicEvent() {
		if (economicEvent == null) {
			economicEvent = new EObjectResolvingEList<EconomicEvent>(EconomicEvent.class, this, REA_EML_BCPackage.DUALITY__ECONOMIC_EVENT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case REA_EML_BCPackage.DUALITY__ECONOMIC_EVENT:
