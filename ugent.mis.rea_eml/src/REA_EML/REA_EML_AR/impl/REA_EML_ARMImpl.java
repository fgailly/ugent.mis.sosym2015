 ...
 * <ul>
 *   <li>{@link REA_EML.REA_EML_AR.impl.REA_EML_ARMImpl#getEconomicEvents <em>Economic Events</em>}</li>
 *   <li>{@link REA_EML.REA_EML_AR.impl.REA_EML_ARMImpl#getEconomicResources <em>Economic Resources</em>}</li>
 *   <li>{@link REA_EML.REA_EML_AR.impl.REA_EML_ARMImpl#getEconomicAgents <em>Economic Agents</em>}</li>
 *   <li>{@link REA_EML.REA_EML_AR.impl.REA_EML_ARMImpl#getDualities <em>Dualities</em>}</li>
 *   <li>{@link REA_EML.REA_EML_AR.impl.REA_EML_ARMImpl#getCommitments <em>Commitments</em>}</li>
 *   <li>{@link REA_EML.REA_EML_AR.impl.REA_EML_ARMImpl#getReciprocities <em>Reciprocities</em>}</li>
 *   <li>{@link REA_EML.REA_EML_AR.impl.REA_EML_ARMImpl#getStockflows <em>Stockflows</em>}</li>
 *   <li>{@link REA_EML.REA_EML_AR.impl.REA_EML_ARMImpl#getParticipations <em>Participations</em>}</li>
 *   <li>{@link REA_EML.REA_EML_AR.impl.REA_EML_ARMImpl#getFulfillments <em>Fulfillments</em>}</li>
 *   <li>{@link REA_EML.REA_EML_AR.impl.REA_EML_ARMImpl#getSpecifications <em>Specifications</em>}</li>
 *   <li>{@link REA_EML.REA_EML_AR.impl.REA_EML_ARMImpl#getOrganisationalUnit <em>Organisational Unit</em>}</li>
 *   <li>{@link REA_EML.REA_EML_AR.impl.REA_EML_ARMImpl#getBusinessProcess <em>Business Process</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class REA_EML_ARMImpl extends ModelImpl implements REA_EML_ARM {
	/**
	...
	protected EClass eStaticClass() {
		return REA_EML_ARPackage.Literals.REA_EML_AR_M;
	}
	...
	public EList<EconomicEvent> getEconomicEvents() {
		if (economicEvents == null) {
			economicEvents = new EObjectContainmentEList<EconomicEvent>(EconomicEvent.class, this, REA_EML_ARPackage.REA_EML_AR_M__ECONOMIC_EVENTS);
		}
	...
	public EList<EconomicResource> getEconomicResources() {
		if (economicResources == null) {
			economicResources = new EObjectContainmentEList<EconomicResource>(EconomicResource.class, this, REA_EML_ARPackage.REA_EML_AR_M__ECONOMIC_RESOURCES);
		}
	...
	public EList<EconomicAgent> getEconomicAgents() {
		if (economicAgents == null) {
			economicAgents = new EObjectContainmentEList<EconomicAgent>(EconomicAgent.class, this, REA_EML_ARPackage.REA_EML_AR_M__ECONOMIC_AGENTS);
		}
	...
	public EList<duality> getDualities() {
		if (dualities == null) {
			dualities = new EObjectContainmentEList<duality>(duality.class, this, REA_EML_ARPackage.REA_EML_AR_M__DUALITIES);
		}
		return dualities;
	}
	...
	public EList<Commitment> getCommitments() {
		if (commitments == null) {
			commitments = new EObjectContainmentEList<Commitment>(Commitment.class, this, REA_EML_ARPackage.REA_EML_AR_M__COMMITMENTS);
		}
		return commitments;
	}
	...
	public EList<reciprocity> getReciprocities() {
		if (reciprocities == null) {
			reciprocities = new EObjectContainmentEList<reciprocity>(reciprocity.class, this, REA_EML_ARPackage.REA_EML_AR_M__RECIPROCITIES);
		}
	...
	public EList<stockflow> getStockflows() {
		if (stockflows == null) {
			stockflows = new EObjectContainmentEList<stockflow>(stockflow.class, this, REA_EML_ARPackage.REA_EML_AR_M__STOCKFLOWS);
		}
		return stockflows;
	}
	...
	public EList<participation> getParticipations() {
		if (participations == null) {
			participations = new EObjectContainmentEList<participation>(participation.class, this, REA_EML_ARPackage.REA_EML_AR_M__PARTICIPATIONS);
		}
	...
	public EList<fulfillment> getFulfillments() {
		if (fulfillments == null) {
			fulfillments = new EObjectContainmentEList<fulfillment>(fulfillment.class, this, REA_EML_ARPackage.REA_EML_AR_M__FULFILLMENTS);
		}
		return fulfillments;
	}
	...
	public EList<specification> getSpecifications() {
		if (specifications == null) {
			specifications = new EObjectContainmentEList<specification>(specification.class, this, REA_EML_ARPackage.REA_EML_AR_M__SPECIFICATIONS);
		}
	...
	public void setOrganisationalUnit(String newOrganisationalUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, REA_EML_ARPackage.REA_EML_AR_M__ORGANISATIONAL_UNIT, oldOrganisationalUnit, organisationalUnit));
	}
	...
	public void setBusinessProcess(String newBusinessProcess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, REA_EML_ARPackage.REA_EML_AR_M__BUSINESS_PROCESS, oldBusinessProcess, businessProcess));
	}
