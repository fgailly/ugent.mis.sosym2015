...
import REA_EML.REA_EML_AR.fulfillment;
 ...
 * @generated
 */
public class REA_EML_ARPackageImpl extends EPackageImpl implements REA_EML_ARPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass reA_EML_ARMEClass = null;
	 ...
	 * @see REA_EML.REA_EML_AR.REA_EML_ARPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private REA_EML_ARPackageImpl() {
		super(eNS_URI, REA_EML_ARFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link REA_EML_ARPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static REA_EML_ARPackage init() {
		if (isInited) return (REA_EML_ARPackage)EPackage.Registry.INSTANCE.getEPackage(REA_EML_ARPackage.eNS_URI);

		// Obtain or create and register package
		REA_EML_ARPackageImpl theREA_EML_ARPackage = (REA_EML_ARPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof REA_EML_ARPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new REA_EML_ARPackageImpl());
		...
		theREA_EML_ARPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(REA_EML_ARPackage.eNS_URI, theREA_EML_ARPackage);
		return theREA_EML_ARPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getREA_EML_ARM() {
		return reA_EML_ARMEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getREA_EML_ARM_EconomicEvents() {
		return (EReference)reA_EML_ARMEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getREA_EML_ARM_EconomicResources() {
		return (EReference)reA_EML_ARMEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getREA_EML_ARM_EconomicAgents() {
		return (EReference)reA_EML_ARMEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getREA_EML_ARM_Dualities() {
		return (EReference)reA_EML_ARMEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getREA_EML_ARM_Commitments() {
		return (EReference)reA_EML_ARMEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getREA_EML_ARM_Reciprocities() {
		return (EReference)reA_EML_ARMEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EReference getREA_EML_ARM_Stockflows() {
		return (EReference)reA_EML_ARMEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EReference getREA_EML_ARM_Participations() {
		return (EReference)reA_EML_ARMEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 * @generated
	 */
	public EReference getREA_EML_ARM_Fulfillments() {
		return (EReference)reA_EML_ARMEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 * @generated
	 */
	public EReference getREA_EML_ARM_Specifications() {
		return (EReference)reA_EML_ARMEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 * @generated
	 */
	public EAttribute getREA_EML_ARM_OrganisationalUnit() {
		return (EAttribute)reA_EML_ARMEClass.getEStructuralFeatures().get(10);
	}
	 ...
	 * @generated
	 */
	public EAttribute getREA_EML_ARM_BusinessProcess() {
		return (EAttribute)reA_EML_ARMEClass.getEStructuralFeatures().get(11);
	}
	 ...
	 * @generated
	 */
	public REA_EML_ARFactory getREA_EML_ARFactory() {
		return (REA_EML_ARFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		reA_EML_ARMEClass = createEClass(REA_EML_AR_M);
		createEReference(reA_EML_ARMEClass, REA_EML_AR_M__ECONOMIC_EVENTS);
		createEReference(reA_EML_ARMEClass, REA_EML_AR_M__ECONOMIC_RESOURCES);
		createEReference(reA_EML_ARMEClass, REA_EML_AR_M__ECONOMIC_AGENTS);
		createEReference(reA_EML_ARMEClass, REA_EML_AR_M__DUALITIES);
		createEReference(reA_EML_ARMEClass, REA_EML_AR_M__COMMITMENTS);
		createEReference(reA_EML_ARMEClass, REA_EML_AR_M__RECIPROCITIES);
		createEReference(reA_EML_ARMEClass, REA_EML_AR_M__STOCKFLOWS);
		createEReference(reA_EML_ARMEClass, REA_EML_AR_M__PARTICIPATIONS);
		createEReference(reA_EML_ARMEClass, REA_EML_AR_M__FULFILLMENTS);
		createEReference(reA_EML_ARMEClass, REA_EML_AR_M__SPECIFICATIONS);
		createEAttribute(reA_EML_ARMEClass, REA_EML_AR_M__ORGANISATIONAL_UNIT);
		createEAttribute(reA_EML_ARMEClass, REA_EML_AR_M__BUSINESS_PROCESS);
	...
	public void initializePackageContents() {
		...
		reA_EML_ARMEClass.getESuperTypes().add(theREA_EMLPackage.getModel());
		...
		initEClass(reA_EML_ARMEClass, REA_EML_ARM.class, "REA_EML_ARM", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getREA_EML_ARM_EconomicEvents(), this.getEconomicEvent(), null, "economicEvents", null, 0, -1, REA_EML_ARM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getREA_EML_ARM_EconomicResources(), this.getEconomicResource(), null, "economicResources", null, 0, -1, REA_EML_ARM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getREA_EML_ARM_EconomicAgents(), this.getEconomicAgent(), null, "economicAgents", null, 0, -1, REA_EML_ARM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getREA_EML_ARM_Dualities(), this.getduality(), null, "dualities", null, 0, -1, REA_EML_ARM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getREA_EML_ARM_Commitments(), this.getCommitment(), null, "commitments", null, 0, -1, REA_EML_ARM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getREA_EML_ARM_Reciprocities(), this.getreciprocity(), null, "reciprocities", null, 0, -1, REA_EML_ARM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getREA_EML_ARM_Stockflows(), this.getstockflow(), null, "stockflows", null, 0, -1, REA_EML_ARM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getREA_EML_ARM_Participations(), this.getparticipation(), null, "participations", null, 0, -1, REA_EML_ARM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getREA_EML_ARM_Fulfillments(), this.getfulfillment(), null, "fulfillments", null, 0, -1, REA_EML_ARM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getREA_EML_ARM_Specifications(), this.getspecification(), null, "specifications", null, 0, -1, REA_EML_ARM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getREA_EML_ARM_OrganisationalUnit(), ecorePackage.getEString(), "organisationalUnit", null, 0, 1, REA_EML_ARM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getREA_EML_ARM_BusinessProcess(), ecorePackage.getEString(), "businessProcess", null, 0, 1, REA_EML_ARM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
