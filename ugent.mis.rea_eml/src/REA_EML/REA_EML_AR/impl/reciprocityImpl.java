 ...
 * <ul>
 *   <li>{@link REA_EML.REA_EML_AR.impl.reciprocityImpl#getDecrementCommitment <em>Decrement Commitment</em>}</li>
 *   <li>{@link REA_EML.REA_EML_AR.impl.reciprocityImpl#getIncrementCommitment <em>Increment Commitment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class reciprocityImpl extends ModelElementImpl implements reciprocity {
	...
	protected EClass eStaticClass() {
		return REA_EML_ARPackage.Literals.RECIPROCITY;
	}
		...
		if (decrementCommitment != null && decrementCommitment.eIsProxy()) {
			...
			if (decrementCommitment != oldDecrementCommitment) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, REA_EML_ARPackage.RECIPROCITY__DECREMENT_COMMITMENT, oldDecrementCommitment, decrementCommitment));
			}
		}
	...
	public void setDecrementCommitment(DecrementCommitment newDecrementCommitment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, REA_EML_ARPackage.RECIPROCITY__DECREMENT_COMMITMENT, oldDecrementCommitment, decrementCommitment));
	}
	...
	public IncrementCommitment getIncrementCommitment() {
		if (incrementCommitment != null && incrementCommitment.eIsProxy()) {
			...
			if (incrementCommitment != oldIncrementCommitment) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, REA_EML_ARPackage.RECIPROCITY__INCREMENT_COMMITMENT, oldIncrementCommitment, incrementCommitment));
			}
		}
	...
	public void setIncrementCommitment(IncrementCommitment newIncrementCommitment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, REA_EML_ARPackage.RECIPROCITY__INCREMENT_COMMITMENT, oldIncrementCommitment, incrementCommitment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case REA_EML_ARPackage.RECIPROCITY__DECREMENT_COMMITMENT:
				if (resolve) return getDecrementCommitment();
				return basicGetDecrementCommitment();
			case REA_EML_ARPackage.RECIPROCITY__INCREMENT_COMMITMENT:
