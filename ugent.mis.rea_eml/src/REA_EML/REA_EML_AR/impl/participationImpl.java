 ...
 * <ul>
 *   <li>{@link REA_EML.REA_EML_AR.impl.participationImpl#getEconomicAgent <em>Economic Agent</em>}</li>
 *   <li>{@link REA_EML.REA_EML_AR.impl.participationImpl#getEconomicEvent <em>Economic Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class participationImpl extends ModelElementImpl implements participation {
	...
	protected EClass eStaticClass() {
		return REA_EML_ARPackage.Literals.PARTICIPATION;
	}
		...
		if (economicAgent != null && economicAgent.eIsProxy()) {
			...
			if (economicAgent != oldEconomicAgent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, REA_EML_ARPackage.PARTICIPATION__ECONOMIC_AGENT, oldEconomicAgent, economicAgent));
			}
		}
	...
	public void setEconomicAgent(EconomicAgent newEconomicAgent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, REA_EML_ARPackage.PARTICIPATION__ECONOMIC_AGENT, oldEconomicAgent, economicAgent));
	}
	...
	public EconomicEvent getEconomicEvent() {
		if (economicEvent != null && economicEvent.eIsProxy()) {
			...
			if (economicEvent != oldEconomicEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, REA_EML_ARPackage.PARTICIPATION__ECONOMIC_EVENT, oldEconomicEvent, economicEvent));
			}
		}
	...
	public void setEconomicEvent(EconomicEvent newEconomicEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, REA_EML_ARPackage.PARTICIPATION__ECONOMIC_EVENT, oldEconomicEvent, economicEvent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case REA_EML_ARPackage.PARTICIPATION__ECONOMIC_AGENT:
				if (resolve) return getEconomicAgent();
				return basicGetEconomicAgent();
			case REA_EML_ARPackage.PARTICIPATION__ECONOMIC_EVENT:
