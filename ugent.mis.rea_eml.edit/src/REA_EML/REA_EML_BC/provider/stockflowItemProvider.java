...
/**
 * This is the item provider adapter for a {@link REA_EML.REA_EML_BC.stockflow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 REA_EML_BCPackage.Literals.STOCKFLOW__ECONOMIC_EVENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 REA_EML_BCPackage.Literals.STOCKFLOW__ECONOMIC_RESOUCE,
				 true,
				 false,
				 true,
				 null,
