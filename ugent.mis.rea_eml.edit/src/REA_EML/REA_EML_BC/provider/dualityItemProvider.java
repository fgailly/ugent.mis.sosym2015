...
/**
 * This is the item provider adapter for a {@link REA_EML.REA_EML_BC.duality} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class dualityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_duality_economicEvent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_duality_economicEvent_feature", "_UI_duality_type"),
				 REA_EML_BCPackage.Literals.DUALITY__ECONOMIC_EVENT,
				 true,
				 false,
				 true,
				 null,
