...
/**
 * This is the item provider adapter for a {@link REA_EML.REA_EML_BE.BusinessRelationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BusinessRelationship_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BusinessRelationship_target_feature", "_UI_BusinessRelationship_type"),
				 REA_EML_BEPackage.Literals.BUSINESS_RELATIONSHIP__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BusinessRelationship_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BusinessRelationship_source_feature", "_UI_BusinessRelationship_type"),
				 REA_EML_BEPackage.Literals.BUSINESS_RELATIONSHIP__SOURCE,
				 true,
				 false,
				 true,
				 null,
