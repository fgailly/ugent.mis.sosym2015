...
/**
 * This is the item provider adapter for a {@link REA_EML.Model} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 REA_EMLPackage.Literals.MODEL__NAME,
				 true,
				 false,
				 false,
	...
	protected void addOntologyURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Model_ontologyURI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Model_ontologyURI_feature", "_UI_Model_type"),
				 REA_EMLPackage.Literals.MODEL__ONTOLOGY_URI,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addOntologyNSPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Model_ontologyNS_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Model_ontologyNS_feature", "_UI_Model_type"),
				 REA_EMLPackage.Literals.MODEL__ONTOLOGY_NS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
