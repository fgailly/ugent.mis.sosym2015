...
/**
 * This is the item provider adapter for a {@link REA_EML.REA_EML_AR.duality} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 REA_EML_ARPackage.Literals.DUALITY__DECREMENT_ECONOMIC_EVENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 REA_EML_ARPackage.Literals.DUALITY__INCREMENT_ECONOMIC_EVENT,
				 true,
				 false,
				 true,
				 null,
