...
/**
 * This is the item provider adapter for a {@link REA_EML.REA_EML_AR.stockflow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class stockflowItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 REA_EML_ARPackage.Literals.STOCKFLOW__ECONOMIC_EVENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 REA_EML_ARPackage.Literals.STOCKFLOW__ECONOMIC_RESOUCE,
				 true,
				 false,
				 true,
				 null,
