...
/**
 * This is the item provider adapter for a {@link REA_EML.REA_EML_BPM.fulfillment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 REA_EML_BPMPackage.Literals.FULFILLMENT__ECONOMIC_EVENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 REA_EML_BPMPackage.Literals.FULFILLMENT__COMMITMENT,
				 true,
				 false,
				 true,
				 null,
